    ...
    <div>
        ...
        <?php
            ...
            if(isset($_POST["submit2"])){
                    ...
                    mysqli_query($link,"insert into route values('','$_POST[sp]','$_POST[ep]')");

                    mysqli_query($link,"insert into t_time values('','$_POST[st]','$_POST[et]')");
        ...
        if(isset($_POST["submit3"])){
                ...
                mysqli_query($link,"insert into train values('','$_POST[tn]','$_POST[ron1]','$_POST[tid1]')");
